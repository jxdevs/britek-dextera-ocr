...
> = {
  ...
  delete: { label: 'Enviar a papelera', icon: Trash2, tone: 'bg-rose-100 text-rose-700 ring-rose-200' },
  restore: { label: 'Restaurar', icon: RotateCcw, tone: 'bg-sky-100 text-sky-700 ring-sky-200' },
